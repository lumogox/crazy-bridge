...
- [x] **Phase 2: "God Hand" Interaction (Raycasting)**
    ...
    - [x] Visual Feedback: 3D Hand Cursor (replaces reticle).
    - [x] UI Toggle: God Mode button in Disaster panel.
    - [x] Mechanics: Grab cars, debris, ships, and rip static voxels.
